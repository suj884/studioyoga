 ...
 * Permite enviar mensajes de contacto por correo electrónico al administrador del sitio.
 */
@Controller
public class ContactController {
    ...
    /**
     * Procesa el envío del formulario de contacto y envía un correo electrónico al administrador.
     *
    ...
    public String sendContact(
        ...
        redirectAttributes.addFlashAttribute("success", "¡Mensaje enviado correctamente! Nos pondremos en contacto contigo pronto.");
